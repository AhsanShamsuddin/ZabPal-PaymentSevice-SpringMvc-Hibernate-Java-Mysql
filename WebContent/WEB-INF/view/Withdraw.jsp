...
<body>
	...
	<form:form id="frm1" name="regForm" modelAttribute="wd" action = "subAmount" method="get" >
	  <div class="form-group">
	    <label for="egFN">Withdraw Amount</label>
	    <form:input path="Total_balance" class="form-control" id="egFN" placeholder="Enter Amount"></form:input>
	  	<p id="demo"></p>
	  </div>
	  
	  <input class="btn btn-lg btn-success" type="submit" id="btn" value="Withdraw Amount">
	</form:form>

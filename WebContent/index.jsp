...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">ZABPAL</a></h1>
          ...
          <li class="menu-has-children"><a href="">Drop Down</a>
            <ul>
              ...
              <li class="menu-has-children"><a href="#">Drop Down 2</a>
                <ul>
                  <li><a href="#">E-TRANSACTION</a></li>
                  <li><a href="#">TRACK YOUR E-TRANSACTION</a></li>
                  <li><a href="#">VIEW YOUR ACCOUNT DETAIL</a></li>
  ...
  <section id="intro">
    ...
    <div class="intro-text">
      <h2>Welcome to ZABPAL</h2>
      <p>We are team of talanted developers making websites with Spring</p>
      ...
      <div class="container-fluid">
        <div class="section-header">
          ...
          <p class="section-description">
            Make An Online Account and do an Online and secure transactions<br>
      ...
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="img/team/asad.jpg" alt=""></div>
              <h4>Asad Ali</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="img/team/ahsan.PNG" alt=""></div>
              <h4>Ahsan Maredia</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="img/team/arsalan.PNG" alt=""></div>
              <h4>Arsalan Saleem</h4>
              <span>CTO</span>
              <div class="social">
                <a href=""><i class="fa fa-twitter"></i></a>
                <a href=""><i class="fa fa-facebook"></i></a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="img/team/ahmed.PNG" alt=""></div>
              <h4>Ahmed Zubair</h4>
        ...
        <div class="row wow fadeInUp">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="contact-about">
              <h3>ZABPAL</h3>
              <p>MAKE AN EASIER AND SECURE PAYMENT THROUGH ZABPAL.</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 text-lg-left text-center">
          <div class="copyright">
            &copy; Copyright <strong>ZABPAL</strong>. All Rights Reserved
          </div>
          <div class="credits">
            <!--
